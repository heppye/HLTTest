# /users/yechen/CMSSW_8_0_12/HLTMSSMHbbTest/V2 (CMSSW_8_0_12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/yechen/CMSSW_8_0_12/HLTMSSMHbbTest/V2')
)
...
process.hltL1sDoubleJetC112 = cms.EDFilter( "HLTL1TSeed",
...
process.hltSingleBTagCSV0p84 = cms.EDFilter( "HLTCaloJetTagWithMatching",
    saveTags = cms.bool( True ),
    deltaR = cms.double( 10.0 ),
    MinJets = cms.int32( 1 ),
    JetTags = cms.InputTag( "hltCombinedSecondaryVertexBJetTagsCalo" ),
...
process.hltPreDoubleJetsC100SingleBTagCSVp026SinglePFJetC350 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltJetC350 = cms.EDFilter( "HLT1PFJet",
    saveTags = cms.bool( True ),
...
process.hltPreDoubleJetsC100SingleBTagCSVp014SinglePFJetC350 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_DoubleJetsC100_SingleBTagCSV_p026_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleJetC100 + process.hltPreDoubleJetsC100SingleBTagCSVp026 + process.HLTAK4CaloJetsSequence + process.hltDoubleJetsC100 + process.HLTFastPrimaryVertexSequence + process.hltSelectorJets80L1FastJet + process.hltSelectorCentralJets80L1FastJet + process.hltSelector6CentralJetsL1FastJet + process.HLTBtagCSVSequenceL3 + process.hltSingleBTagCSV0p78 + process.HLTEndSequence )
process.HLT_DoubleJetsC100_SingleBTagCSV_p014_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleJetC100 + process.hltPreDoubleJetsC100SingleBTagCSVp014 + process.HLTAK4CaloJetsSequence + process.hltDoubleJetsC100 + process.HLTFastPrimaryVertexSequence + process.hltSelectorJets80L1FastJet + process.hltSelectorCentralJets80L1FastJet + process.hltSelector6CentralJetsL1FastJet + process.HLTBtagCSVSequenceL3 + process.hltSingleBTagCSV0p84 + process.HLTEndSequence )
process.HLT_DoubleJetsC100_SingleBTagCSV_p026_SinglePFJetC350_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleJetC100 + process.hltPreDoubleJetsC100SingleBTagCSVp026SinglePFJetC350 + process.HLTAK4CaloJetsSequence + process.hltDoubleJetsC100 + process.HLTFastPrimaryVertexSequence + process.hltSelectorJets80L1FastJet + process.hltSelectorCentralJets80L1FastJet + process.hltSelector6CentralJetsL1FastJet + process.HLTBtagCSVSequenceL3 + process.hltSingleBTagCSV0p78 + process.HLTAK4PFJetsSequence + process.hltJetC350 + process.HLTEndSequence )
process.HLT_DoubleJetsC100_SingleBTagCSV_p014_SinglePFJetC350_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleJetC100 + process.hltPreDoubleJetsC100SingleBTagCSVp014SinglePFJetC350 + process.HLTAK4CaloJetsSequence + process.hltDoubleJetsC100 + process.HLTFastPrimaryVertexSequence + process.hltSelectorJets80L1FastJet + process.hltSelectorCentralJets80L1FastJet + process.hltSelector6CentralJetsL1FastJet + process.HLTBtagCSVSequenceL3 + process.hltSingleBTagCSV0p84 + process.HLTAK4PFJetsSequence + process.hltJetC350 + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_DoubleJetsC100_DoubleBTagCSV_p026_DoublePFJetsC160_v3, process.HLT_DoubleJetsC100_DoubleBTagCSV_p014_DoublePFJetsC100MaxDeta1p6_v3, process.HLT_DoubleJetsC112_DoubleBTagCSV_p026_DoublePFJetsC172_v3, process.HLT_DoubleJetsC112_DoubleBTagCSV_p014_DoublePFJetsC112MaxDeta1p6_v3, process.HLT_DoubleJetsC100_SingleBTagCSV_p026_v2, process.HLT_DoubleJetsC100_SingleBTagCSV_p014_v2, process.HLT_DoubleJetsC100_SingleBTagCSV_p026_SinglePFJetC350_v3, process.HLT_DoubleJetsC100_SingleBTagCSV_p014_SinglePFJetC350_v3, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/desy.de/user/y/yechen/workspace/temp/HLTPhysics0Raw.root',
    ),
...
_customInfo['inputFile' ]=  ['file:/afs/desy.de/user/y/yechen/workspace/temp/HLTPhysics0Raw.root']
...
#))), 
     outputCommands = cms.untracked.vstring(
      'drop *',
      #'keep recoVertexs_hltFastPVPixelVertices_*_*',
      #'keep recoVertexs_hltFastPrimaryVertex_*_*',
      #'keep *_hltInclusiveMergedVertices*_*_*',
      #'keep recoVertexs_offline*_*_*',
      #'keep l1extraL1JetParticles_*_*_*',
      #'keep recoCaloJets_hltAK4CaloJetsCorrectedIDPassed_*_*',
      ...
      #'keep *_jetFlavourInfosAK4PFJets_*_*',
      #'keep PileupSummaryInfos_*_*_*',
      'keep edmTriggerResults_*_*_TEST',
 ),
     fileName = cms.untracked.string('file:hlt_HLTMSSMHBBTEST_v3_save.root'),
)
process.output_step = cms.EndPath(process.output)

### disabling 2016 CCC mitigation @filtering step
process.HLTIter2PSetTrajectoryFilterIT.minGoodStripCharge = cms.PSet(  refToPSet_ = cms.string( "HLTSiStripClusterChargeCutNone" ) ) # HLTSiStripClusterChargeCutLoose in 2016
process.HLTIter2PSetTrajectoryFilterIT.maxCCCLostHits     = cms.int32( 9999 ) # 1 in 2016

process.HLTIter1PSetTrajectoryFilterIT.minGoodStripCharge = cms.PSet(  refToPSet_ = cms.string( "HLTSiStripClusterChargeCutNone" ) ) # HLTSiStripClusterChargeCutLoose in 2016
process.HLTIter1PSetTrajectoryFilterIT.maxCCCLostHits     = cms.int32( 9999 ) # 1 in 2016

process.HLTIter0PSetTrajectoryFilterIT.minGoodStripCharge = cms.PSet(  refToPSet_ = cms.string( "HLTSiStripClusterChargeCutNone" ) ) # HLTSiStripClusterChargeCutLoose in 2016
process.HLTIter0PSetTrajectoryFilterIT.maxCCCLostHits     = cms.int32( 9999 ) # 1 in 2016

### rollback to 2015 CCC @building step
process.hltESPChi2ChargeMeasurementEstimator16.clusterChargeCut = cms.PSet(  refToPSet_ = cms.string( "HLTSiStripClusterChargeCutLoose" ) ) # HLTSiStripClusterChargeCutTiny in 2016
process.hltESPChi2ChargeMeasurementEstimator9.clusterChargeCut  = cms.PSet(  refToPSet_ = cms.string( "HLTSiStripClusterChargeCutLoose" ) ) # HLTSiStripClusterChargeCutTiny in 2016
